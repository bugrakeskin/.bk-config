...
echo -e 'Update & auto remove:{\e[32mupdate\e[0m} | Color Tail:{\e[32mct\e[0m} | Color CAT:{\e[32mxcat\e[0m} | List(short):{\e[32mls\e[0m} | List(long):{\e[32ml\e[0m} | SUDO/Micro Editor:{\e[32m sm-m \e[0m} | '
